...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	public static enum AnimationStyle {
		...
		LoadingLayout createLoadingLayout(Context context, Mode mode, Orientation scrollDirection, TypedArray attrs) {
			switch (this) {
			case FLIP:
				return new FlipLoadingLayout(context, mode, scrollDirection, attrs,this);
//				return new RotateLoadingLayout(context, mode, scrollDirection, attrs);
			default:
				if (mode == Mode.PULL_FROM_START  && this != NOCHANGE) {
					return new TweenAnimLoadingLayout(context, mode, scrollDirection, attrs,this);
				} else {
					return new RotateLoadingLayout(context, mode, scrollDirection, attrs,this);
				}
