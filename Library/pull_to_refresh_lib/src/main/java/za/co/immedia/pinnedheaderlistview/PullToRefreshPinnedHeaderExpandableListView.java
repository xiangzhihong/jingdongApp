...
public class PullToRefreshPinnedHeaderExpandableListView extends PullToRefreshAdapterViewBase<PinnedHeaderExpandableListView> {
  ...
  public   void onRefreshing(final boolean doScroll) {
   ...
   protected void onReset() {
    ...
    protected PinnedHeaderExpandableListView createListView(Context context, AttributeSet attrs) {
    ...
    protected PinnedHeaderExpandableListView createRefreshableView(Context context, AttributeSet attrs) {
        PinnedHeaderExpandableListView lv = createListView(context, attrs);
    ...
    final class InternalListViewSDK9 extends InternalListView {
        ...
        protected boolean overScrollBy(int deltaX, int deltaY, int scrollX, int scrollY, int scrollRangeX,
            ...
            OverscrollHelper.overScrollBy(PullToRefreshPinnedHeaderExpandableListView.this, deltaX, scrollX, deltaY, scrollY, isTouchEvent);

            return returnValue;
        }
    }

    protected class InternalListView extends PinnedHeaderExpandableListView implements EmptyViewMethodAccessor {
