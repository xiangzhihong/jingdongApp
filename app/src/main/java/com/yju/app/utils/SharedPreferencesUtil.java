...
public class SharedPreferencesUtil {
    ...
    public static SharedPreferencesUtil newInstance(Context context) {
        return new SharedPreferencesUtil(context, DEFAULT_SETTING);
    }

    public static SharedPreferencesUtil newInstance(Context context, String name) {
